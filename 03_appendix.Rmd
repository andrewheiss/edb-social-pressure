...
Sub-indicators for "Starting a Business" with and without country fixed effects.
...
Sub-indicators for "Enforcing Contracts" with and without country fixed effects.
...
Sub-indicators for "Starting a Business" with and without year fixed effects.
...
Sub-indicators for "Enforcing Contracts" with and without year fixed effects.
